...
{return radians*180/Math.PI;};window.requestAnimationFrame=(function()
{return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(callback,element)
{window.setTimeout(callback,1000/60);};})();wamt.play=function(scene)
{var ts=scene;scene.worker=setInterval
(function()
{ts.logic();},16.6666667);};wamt.pause=function(scene)
...
{view.x=view.target.x;view.y=view.target.y;}
...
continue;var ox=object.screenX+object.bounds[0];var oy=object.screenY+object.bounds[1];var cx=ix+(object.bounds[0]*2);var cy=iy+(object.bounds[1]*2);if(((ox>=-cx&&ox<=cx)&&(oy>=-cy&&oy<=cy)&&object.visible)||!wamt.settings.culling)
object.render(view);}
layer.processEvent("tick",{scene:scene,view:view});layer.processEvent("render",{scene:scene,view:view});}
scene.processEvent("tick",{scene:scene,view:view});scene.processEvent("render",{scene:scene,view:view});scene.updated=false;view.updated=false;}
else
...
scene.processEvent("tick",{scene:scene,view:view});}};wamt.Layer=function(scene,index)
{this.events=[];this.scene=scene;this.index=index;this.objects=[];this.opacity=1;this.composite="source-over";this.locked=false;};wamt.Layer.prototype.constructor=wamt.Layer;wamt.Layer.prototype.addObject=function(object)
{object.scene=this.scene;object.layer=this;this.objects.push(object);};wamt.Layer.prototype.removeObject=function(obj)
{this.objects.splice(this.objects.indexOf(obj),1);this.scene.updated=true;};wamt.Layer.prototype.setOpacity=function(opacity)
{this.opacity=opacity;this.scene.updated=true;};wamt.Layer.prototype.clear=function()
{this.objects=[];this.scene.updated=true;};wamt.Layer.prototype.setCompositeOperation=function(type)
{this.composite=type;this.scene.updated=true;};wamt.Layer.prototype.setLocked=function(locked)
{this.locked=locked;this.scene.updated=true;};wamt.Layer.prototype.addEventListener=function(type,bind)
{var e=this.events[type];if(typeof(e)=="undefined")
this.events[type]=[];this.events[type].push(bind);};wamt.Layer.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.Scene=function()
{this.events=[];this.updated=false;this.time=new Date();this.layers=[];};wamt.Scene.prototype.constructor=wamt.Scene;wamt.Scene.prototype.getLayer=function(index)
...
this.updated=true;};wamt.Scene.prototype.removeObject=function(obj)
{this.getLayer(obj.layer.index).removeObject(obj);};wamt.Scene.prototype.clear=function()
{this.layers=[];this.updated=true;};wamt.Scene.prototype.logic=function()
{for(var j=0;j<this.layers.length;j++)
{var layer=this.layers[j];for(var i=0;i<layer.objects.length;i++)
{var object=layer.objects[i];object.logic(this);}}
this.processEvent("logic",{scene:this});};wamt.Scene.prototype.addEventListener=function(type,bind)
{var e=this.events[type];if(typeof(e)=="undefined")
this.events[type]=[];this.events[type].push(bind);};wamt.Scene.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.View=function(canvas,x,y)
{this.events=[];this.canvas=canvas;this.context=canvas.getContext("2d");this.x=typeof(x)=="undefined"?canvas.width/2:x;this.y=typeof(y)=="undefined"?canvas.height/2:y;};wamt.View.prototype.constructor=wamt.View;wamt.View.prototype.addEventListener=function(type,bind)
{var e=this.events[type];if(typeof(e)=="undefined")
this.events[type]=[];this.events[type].push(bind);switch(type)
{case"mousemove":this.canvas.addEventListener("mousemove",function(event)
{event.view=this;event.context=this.view;bind(event);},false);break;case"mousedown":this.canvas.addEventListener("mousedown",function(event)
{event.view=this;event.context=this.view;bind(event);},false);break;case"mouseup":this.canvas.addEventListener("mouseup",function(event)
{event.view=this;event.context=this.view;bind(event);},false);break;case"click":this.canvas.addEventListener("click",function(event)
{event.view=this;event.context=this.view;bind(event);},false);break;}};wamt.View.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.View.prototype.setBackdrop=function(value)
...
{this.events=[];this.collideable=true;this.x=typeof(x)=="undefined"?0:x;this.y=typeof(y)=="undefined"?0:y;this.velocity=[0,0];this.screenX=this.x;this.screenY=this.y;this.angle=typeof(angle)=="undefined"?0:angle;this.radians=typeof(angle)=="undefined"?0:Math.radians(angle);this.width=width;this.height=height;this.style=style;this.shadow=[0,0,0,"rgba(0,0,0,0)"];this.hollow=false;this.visible=true;this.computeBounds();};wamt.Box.prototype.constructor=wamt.Box;wamt.Box.prototype.computeBounds=function()
...
{this.collideable=colliding;};wamt.Box.prototype.setVisible=function(visible)
{this.visible=visible;this.scene.updated=true;};wamt.Box.prototype.setHollow=function(hollow)
{this.hollow=hollow;this.scene.updated=true;};wamt.Box.prototype.logic=function(scene)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.velocity(this);else
this.translate(this.velocity[0],this.velocity[1]);}
if(typeof(this.behaviour)!="undefined")
this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:scene});};wamt.Box.prototype.tick=function(scene,layer,view)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.pretick(this);if(scene.updated)
{if(layer.locked)
...
{this.x=x;this.y=y;this.scene.updated=true;};wamt.Box.prototype.snap=function(x,y)
{this.translate(-(this.x%x),-(this.y%y));};wamt.Box.prototype.translateX=function(x)
...
{this.angle=angle%360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Box.prototype.rotate=function(angle)
{this.angle+=angle;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Box.prototype.setBehaviour=function(behaviour)
{this.behaviour=behaviour;behaviour.init(this);this.scene.updated=true;};wamt.Box.prototype.addEventListener=function(type,bind)
{var e=this.events[type];if(typeof(e)=="undefined")
this.events[type]=[];this.events[type].push(bind);};wamt.Box.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.Box.prototype.destroy=function()
{this.scene.removeObject(this);};wamt.Circle=function(style,radius,x,y,angle)
{this.events=[];this.collideable=true;this.x=typeof(x)=="undefined"?0:x;this.y=typeof(y)=="undefined"?0:y;this.velocity=[0,0];this.screenX=this.x;this.screenY=this.y;this.angle=typeof(angle)=="undefined"?0:angle;this.radians=typeof(angle)=="undefined"?0:Math.radians(angle);this.radius=radius;this.style=style;this.shadow=[0,0,0,"rgba(0,0,0,0)"];this.shadowcast=false;this.hollow=false;this.visible=true;this.computeBounds();};wamt.Circle.prototype.constructor=wamt.Circle;wamt.Circle.prototype.computeBounds=function()
{this.bounds=[this.radius*2,this.radius*2];};wamt.Circle.prototype.setColliding=function(colliding)
{this.collideable=colliding;};wamt.Circle.prototype.setVisible=function(visible)
{this.visible=visible;this.scene.updated=true;};wamt.Circle.prototype.setHollow=function(hollow)
{this.hollow=hollow;this.scene.updated=true;};wamt.Circle.prototype.logic=function(scene)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.velocity(this);else
this.translate(this.velocity[0],this.velocity[1]);}
if(typeof(this.behaviour)!="undefined")
this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:scene});};wamt.Circle.prototype.tick=function(scene,layer,view)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.pretick(this);if(scene.updated)
{if(layer.locked)
{this.screenX=this.x;this.screenY=this.y;}
...
{this.x=x;this.y=y;this.scene.updated=true;};wamt.Circle.prototype.snap=function(x,y)
{this.translate(-(this.x%x),-(this.y%y));};wamt.Circle.prototype.translateX=function(x)
...
{this.angle=angle%360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Circle.prototype.rotate=function(angle)
{this.angle+=angle;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Circle.prototype.setBehaviour=function(behaviour)
{this.behaviour=behaviour;behaviour.init(this);this.scene.updated=true;};wamt.Circle.prototype.addEventListener=function(type,bind)
{var e=this.events[type];if(typeof(e)=="undefined")
this.events[type]=[];this.events[type].push(bind);};wamt.Circle.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.Circle.prototype.destroy=function()
{this.scene.removeObject(this);};wamt.collision={};wamt.collision.screenPointTest=function(target,x,y,n)
{var collisions=[];if(target instanceof wamt.Layer)
{for(var i=0;i<target.objects.length;i++)
{var b=target.objects[i];if(!b.collideable||b==n)
continue;if(b instanceof wamt.Text)
...
{var b=layer.objects[i];if(!b.collideable||b==n)
continue;if(b.screenX<=x&&b.screenX+b.bounds[0]>=x&&b.screenY<=y&&b.screenY+b.bounds[1]>=y)
collisions.push(b);}}}
return collisions;};wamt.collision.boxSearch=function(target,x,y,width,height,n)
{var collisions=[];if(target instanceof wamt.Layer)
{for(var i=0;i<target.objects.length;i++)
{var b=target.objects[i];if(!b.collideable||b==n)
continue;if(!(b.x>x+width||b.x+b.bounds[0]<x||b.y>y+height||b.y+b.bounds[1]<y))
collisions.push(b);}}
else
{for(var l=0;l<target.layers.length;l++)
{var layer=target.layers[l];for(var i=0;i<layer.objects.length;i++)
...
continue;if(!(b.x>x+width||b.x+b.bounds[0]<x||b.y>y+height||b.y+b.bounds[1]<y))
collisions.push(b);}}}
return collisions;};wamt.collision.pointTest=function(target,x,y,n)
{var collisions=[];if(target instanceof wamt.Layer)
{for(var i=0;i<target.objects.length;i++)
{var b=target.objects[i];if(!b.collideable||b==n)
continue;if(b instanceof wamt.Text)
...
{if(b.x<=x&&b.x+b.bounds[0]>=x&&b.y<=y&&b.y+b.bounds[1]>=y)
collisions.push(b);}}}}
return collisions;};wamt.collision.intersectTest=function(target,a)
{var collisions=[];if(target instanceof wamt.Layer)
{for(var i=0;i<target.objects.length;i++)
{var b=target.objects[i];if(!b.collideable||b==a)
...
{this.events=[];this.collideable=false;this.x=typeof(x)=="undefined"?0:x;this.y=typeof(y)=="undefined"?0:y;this.velocity=[0,0];this.screenX=this.x;this.screenY=this.y;this.intensity=intensity;this.color=color;this.visible=true;this.computeBounds();};wamt.Light.prototype.constructor=wamt.Light;wamt.Light.prototype.computeBounds=function()
{this.bounds=[this.intensity*2,this.intensity*2];};wamt.Light.prototype.setVisible=function(visible)
{this.visible=visible;this.scene.updated=true;};wamt.Light.prototype.logic=function(scene,layer,view)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.velocity(this);else
this.translate(this.velocity[0],this.velocity[1]);}
if(typeof(this.behaviour)!="undefined")
this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:scene});};wamt.Light.prototype.tick=function(scene,layer,view)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.pretick(this);if(scene.updated)
{if(layer.locked)
{this.screenX=this.x;this.screenY=this.y;}
...
{this.x=x;this.y=y;this.scene.updated=true;};wamt.Light.prototype.snap=function(x,y)
{this.translate(-(this.x%x),-(this.y%y));};wamt.Light.prototype.translateX=function(x)
...
{this.behaviour=behaviour;behaviour.init(this);this.scene.updated=true;};wamt.Light.prototype.addEventListener=function(type,bind)
{var e=this.events[type];if(typeof(e)=="undefined")
this.events[type]=[];this.events[type].push(bind);};wamt.Light.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.Light.prototype.destroy=function()
{this.scene.removeObject(this);};wamt.Polygon=function(style,vertices,x,y,angle)
{this.events=[];this.collideable=true;this.x=typeof(x)=="undefined"?0:x;this.y=typeof(y)=="undefined"?0:y;this.velocity=[0,0];this.screenX=this.x;this.screenY=this.y;this.angle=typeof(angle)=="undefined"?0:angle;this.radians=typeof(angle)=="undefined"?0:Math.radians(angle);this.vertices=vertices;this.style=style;this.shadow=[0,0,0,"rgba(0,0,0,0)"];this.shadowcast=false;this.visible=true;this.computeBounds();};wamt.Polygon.prototype.constructor=wamt.Polygon;wamt.Polygon.prototype.computeBounds=function()
...
{this.collideable=colliding;this.scene.updated=true;};wamt.Polygon.prototype.setVisible=function(visible)
{this.visible=visible;this.scene.updated=true;};wamt.Polygon.prototype.setHollow=function(hollow)
{this.hollow=hollow;this.scene.updated=true;};wamt.Polygon.prototype.logic=function(scene)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.velocity(this);else
this.translate(this.velocity[0],this.velocity[1]);}
if(typeof(this.behaviour)!="undefined")
this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:scene});};wamt.Polygon.prototype.tick=function(scene,layer,view)
{if(scene.updated)
{if(layer.locked)
{this.screenX=this.x;this.screenY=this.y;}
else
...
{this.x=x;this.y=y;this.scene.updated=true;};wamt.Polygon.prototype.snap=function(x,y)
{this.translate(-(this.x%x),-(this.y%y));};wamt.Polygon.prototype.translateX=function(x)
...
{this.angle=angle%360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Polygon.prototype.rotate=function(angle)
{this.angle+=angle;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Polygon.prototype.setBehaviour=function(behaviour)
{this.behaviour=behaviour;behaviour.init(this);this.scene.updated=true;};wamt.Polygon.prototype.addEventListener=function(type,bind)
{var e=this.events[type];if(typeof(e)=="undefined")
this.events[type]=[];this.events[type].push(bind);};wamt.Polygon.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.Polygon.prototype.destroy=function()
{this.scene.removeObject(this);};wamt.Sprite=function(image,x,y,angle)
{this.events=[];this.collideable=true;this.image=image;this.x=typeof(x)=="undefined"?0:x;this.y=typeof(y)=="undefined"?0:y;this.velocity=[0,0];this.tileWidth=0;this.tileHeight=0;this.tileAnimation="";this.tileAnimationFrame=0;this.tileAnimationSpeed=0;this.tileAnimations=[];this.screenX=this.x;this.screenY=this.y;this.angle=typeof(angle)=="undefined"?0:angle;this.radians=typeof(angle)=="undefined"?0:Math.radians(angle);this.width=image.width;this.height=image.height;this.shadow=[0,0,0,"rgba(0,0,0,0)"];this.shadowcast=false;this.visible=true;this.computeBounds();};wamt.Sprite.prototype.constructor=wamt.Sprite;wamt.Sprite.prototype.computeBounds=function()
{if(this.angle==0||this.angle==180)
this.bounds=[this.width,this.height];else if(this.angle==90||this.angle==270)
this.bounds=[this.height,this.width];else
...
{this.collideable=colliding;};wamt.Sprite.prototype.setVisible=function(visible)
{this.visible=visible;this.scene.updated=true;};wamt.Sprite.prototype.logic=function(scene)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.velocity(this);else
this.translate(this.velocity[0],this.velocity[1]);}
if(typeof(this.behaviour)!="undefined")
this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:scene});};wamt.Sprite.prototype.tick=function(scene,layer,view)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.pretick(this);if(scene.updated)
{if(layer.locked)
{this.screenX=this.x;this.screenY=this.y;}
...
{this.x=x;this.y=y;this.scene.updated=true;};wamt.Sprite.prototype.snap=function(x,y)
{this.translate(-(this.x%x),-(this.y%y));};wamt.Sprite.prototype.translateX=function(x)
...
{this.angle=angle%360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Sprite.prototype.rotate=function(angle)
{this.angle+=angle;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Sprite.prototype.setBehaviour=function(behaviour)
{this.behaviour=behaviour;behaviour.init(this);this.scene.updated=true;};wamt.Sprite.prototype.addEventListener=function(type,bind)
{var e=this.events[type];if(typeof(e)=="undefined")
this.events[type]=[];this.events[type].push(bind);};wamt.Sprite.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.Sprite.prototype.destroy=function()
{this.scene.removeObject(this);};wamt.Text=function(text,font,style,x,y,angle)
{this.events=[];this.collideable=false;this.x=typeof(x)=="undefined"?0:x;this.y=typeof(y)=="undefined"?0:y;this.velocity=[0,0];this.screenX=this.x;this.screenY=this.y;this.angle=typeof(angle)=="undefined"?0:angle;this.radians=typeof(angle)=="undefined"?0:Math.radians(angle);this.width=1;this.height=10;this.text=String(text).split("\n");this.font=font;this.style=style;this.align="start";this.shadow=[0,0,0,"rgba(0,0,0,0)"];this.hollow=false;this.visible=true;this.updated=true;this.computeBounds();};wamt.Text.prototype.constructor=wamt.Text;wamt.Text.prototype.computeBounds=function()
{if(this.angle==0||this.angle==180)
this.bounds=[this.width,this.height];else if(this.angle==90||this.angle==270)
this.bounds=[this.height,this.width];else
...
{this.collideable=colliding;};wamt.Text.prototype.setVisible=function(visible)
{this.visible=visible;this.scene.updated=true;};wamt.Text.prototype.setHollow=function(hollow)
{this.hollow=hollow;this.scene.updated=true;};wamt.Text.prototype.logic=function(scene,layer,view)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.velocity(this);else
this.translate(this.velocity[0],this.velocity[1]);}
if(typeof(this.behaviour)!="undefined")
this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:scene});};wamt.Text.prototype.tick=function(scene,layer,view)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.pretick(this);if(scene.updated)
{if(this.updated)
...
this.height=10;this.computeBounds();this.updated=false;}
if(layer.locked)
{this.screenX=this.x;this.screenY=this.y;}
else
{this.screenX=-view.x+this.x+(view.canvas.width/2);this.screenY=-view.y+this.y+(view.canvas.height/2);}}
...
{var text=this.text[i];view.context.strokeText(text,this.screenX,this.screenY+(i*this.height*1.5));}}
else
{for(var i=0;i<this.text.length;i++)
{var text=this.text[i];view.context.fillText(text,this.screenX,this.screenY+(i*this.height*1.5));}}}
else
{var transx=(this.width/2)+this.screenX;var transy=(this.height/2)+this.screenY;view.context.save();view.context.translate(transx,transy);view.context.rotate(radians);view.context.translate(-transx,-transy);if(this.hollow)
{for(var i=0;i<this.text.length;i++)
{var text=this.text[i];view.context.strokeText(text,this.screenX,this.screenY+(i*this.height*1.5));}}
...
{this.text=String(text).split("\n");this.updated=true;this.scene.updated=true;};wamt.Text.prototype.setShadow=function(offsetx,offsety,blur,color)
...
{this.x=x;this.y=y;this.scene.updated=true;};wamt.Text.prototype.snap=function(x,y)
{this.translate(-(this.x%x),-(this.y%y));};wamt.Text.prototype.setVelocity=function(x,y)
...
{this.angle=angle%360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Text.prototype.rotate=function(angle)
{this.angle+=angle;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Text.prototype.setBehaviour=function(behaviour)
...
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
{e[i](holder);}}};wamt.Text.prototype.destroy=function()
