...
wamt.process=function(a,b){var c=new Date;wamt.delta=c-wamt.time;wamt.fps=Math.round(1E3/wamt.delta);wamt.time=c;var c=a.layers,d=b.canvas,e=b.context;if(a.updated||b.updated){b.clearCanvas();b.renderBackdrop();var f=b.target;if(typeof f!="undefined")b.x=f.x,b.y=f.y;for(var f=d.width,d=d.height,g=0;g<c.length;g++){var i=c[g];e.globalCompositeOperation=i.composite;var h=i.opacity;e.globalAlpha=h;for(var j=i.objects,l=0;l<j.length;l++){var k=j[l];k.tick(a,i,b);if(typeof k.render!="undefined"&&k.visible){var m=
k.opacity;if(m!=1)e.globalAlpha=h*m;if(wamt.settings.culling){var m=k.screenX+k.bounds[0],n=k.screenY+k.bounds[1],o=f+k.bounds[0]*2,p=d+k.bounds[1]*2;m>=-o&&m<=o&&n>=-p&&n<=p&&k.render(b)}else k.render(b);e.globalAlpha=h}}i.processEvent("tick",{scene:a,view:b});i.processEvent("render",{scene:a,view:b})}a.processEvent("tick",{scene:a,view:b});a.processEvent("render",{scene:a,view:b});a.updated=!1;b.updated=!1}else{for(g=0;g<c.length;g++){i=c[g];j=i.objects;for(l=0;l<j.length;l++)j[l].tick(a,i,b);i.processEvent("tick",
...
wamt.Sprite.prototype.render=function(a){var b=typeof this.behaviour!="undefined";b&&this.behaviour.prerender(this);var c=this.radians,d=a.context;d.shadowOffsetX=this.shadow[0];d.shadowOffsetY=this.shadow[1];d.shadowBlur=this.shadow[2];d.shadowColor=this.shadow[3];var e=this.tileAnimations[this.tileAnimation];if(typeof e=="undefined")if(c==0)d.drawImage(this.image,this.screenX,this.screenY,this.width,this.height);else{var f=this.width/2+this.screenX,g=this.height/2+this.screenY;d.save();d.translate(f,
g);d.rotate(c);d.translate(-f,-g);d.drawImage(this.image,this.screenX,this.screenY,this.width,this.height);d.restore()}else{var i=Math.floor(this.tileAnimationFrame);this.tileAnimationFrame+=this.tileAnimationSpeed/wamt.delta;if(this.tileAnimationFrame>e[2]*e[3]+1)this.tileAnimationFrame=0;f=Math.floor(this.tileAnimationFrame);f!=i&&this.processEvent("frame");var i=Math.floor(f%e[2]),h=Math.floor(f%e[3]);c==0?d.drawImage(this.image,e[0]*this.tileWidth+i*this.tileWidth,e[1]*this.tileHeight+h*this.tileHeight,
this.tileWidth,this.tileHeight,this.screenX,this.screenY,this.width,this.height):(f=this.width/2+this.screenX,g=this.height/2+this.screenY,d.save(),d.translate(f,g),d.rotate(c),d.translate(-f,-g),d.drawImage(this.image,e[0]*this.tileWidth+i*this.tileWidth,e[1]*this.tileHeight+h*this.tileHeight,this.tileWidth,this.tileHeight,this.screenX,this.screenY,this.width,this.height),d.restore())}d.shadowOffsetX="";d.shadowOffsetY="";d.shadowBlur="";d.shadowColor="";b&&this.behaviour.render(this);this.processEvent("render",
...
wamt.Text.prototype.setText=function(a){this.text=String(a).split("\n");this.updated=!0;this.scene.updated=!0};wamt.Text.prototype.setTextAlign=function(a){this.align=a;this.scene.updated=!0};wamt.Text.prototype.setShadow=function(a,b,c,d){this.shadow=[a,b,c,d];this.scene.updated=!0};wamt.Text.prototype.setShadowCasting=function(a){this.shadowcast=a;this.scene.updated=!0};wamt.Text.prototype.setX=function(a){this.x=a;this.scene.updated=!0};
...
wamt.Text.prototype.destroy=function(){this.scene.removeObject(this)};wamt.collision={};
...
wamt.Image.prototype.setPixel=function(a,b,c,d,e,f){var g=this.data,a=(a+b*this.width)*4;c instanceof Array&&(f=c,c=f[0],d=f[1],e=f[2],f=f[3]);g.data[a+0]=c;g.data[a+1]=d;g.data[a+2]=e;g.data[a+3]=f;this.render()};wamt.Image.prototype.drawObject=function(a){a.render({context:this.context});this.render();this.update()};wamt.Image.prototype.fillRect=function(a,b,c,d,e){var f=this.context;f.fillStyle=a;f.fillRect(b,c,d,e);this.render();this.update()};
wamt.Image.prototype.strokeRect=function(a,b,c,d,e){var f=this.context;f.strokeStyle=a;f.strokeRect(b,c,d,e);this.render();this.update()};wamt.Image.prototype.fillText=function(a,b,c,d){var e=this.context;e.fillStyle=a;e.fillText(d,b,c);this.render();this.update()};wamt.Image.prototype.strokeText=function(a,b,c,d){var e=this.context;e.strokeStyle=a;e.strokeText(d,b,c);this.render();this.update()};
wamt.Image.prototype.fillCircle=function(a,b,c,d){var e=this.context;e.fillStyle=a;e.beginPath();e.arc(b,c,d,0,Math.PI*2,!1);e.fill();this.render();this.update()};wamt.Image.prototype.strokeCircle=function(a,b,c,d){var e=this.context;e.strokeStyle=a;e.beginPath();e.arc(b,c,d,0,Math.PI*2,!1);e.stroke();this.render();this.update()};
wamt.Image.prototype.fillPolygon=function(a,b,c,d){var e=this.context;e.fillStyle=a;e.beginPath();for(a=0;a<d.length;a++){var f=d[a];e.lineTo(b+f[0],c+f[1])}e.fill();this.render();this.update()};wamt.Image.prototype.strokePolygon=function(a,b,c,d){var e=this.context;e.strokeStyle=a;e.beginPath();for(a=0;a<d.length;a++){var f=d[a];e.lineTo(b+f[0],c+f[1])}e.stroke();this.render();this.update()};
wamt.Image.prototype.fillLine=function(a,b,c,d,e){var f=this.context;f.fillStyle=a;f.beginPath();f.save();f.translate(b,c);f.lineTo(d,e);f.fill();f.restore();this.render();this.update()};wamt.Image.prototype.strokeLine=function(a,b,c,d,e){var f=this.context;f.strokeStyle=a;f.beginPath();f.save();f.translate(b,c);f.lineTo(d,e);f.stroke();f.restore();this.render();this.update()};
wamt.Image.prototype.getPixel=function(a,b){var c=this.data,d=(a+b*this.width)*4;return[c.data[d+0],c.data[d+1],c.data[d+2],c[d+3]]};wamt.Image.prototype.update=function(){this.data=this.context.getImageData(0,0,0,0,this.width,this.height)};wamt.Image.prototype.render=function(){var a=this.canvas;a.width=this.width;a.height=this.height;this.context.putImageData(this.data,0,0);return this.canvas};
wamt.Image.prototype.empty=function(a,b){var c=this.canvas,d=this.context;c.width=a;c.height=b;this.width=a;this.height=b;this.data=d.createImageData(a,b)};wamt.Image.prototype.load=function(a,b,c){var d=this.canvas,e=this.context;if(typeof b=="undefined")b=a.width;if(typeof c=="undefined")c=a.height;this.width=b;this.height=c;d.width=b;d.height=c;e.drawImage(a,0,0,b,c);this.data=e.getImageData(0,0,b,c)};
