var wamt={};wamt.support={canvas:typeof(window.CanvasRenderingContext2D)!="undefined",ajax:typeof(window.XMLHttpRequest)!="undefined",socket:typeof(window.WebSocket)!="undefined",local:typeof(localStorage)!="undefined",light:typeof(window.CanvasRenderingContext2D.prototype.createRadialGradient)!="undefined"&&typeof(window.CanvasRenderingContext2D.prototype.setShadow)!="undefined"};wamt.settings={culling:true,smoothing:true};wamt.events={subscriptions:[]};wamt.events.addEventType=function(type)
{wamt.events.subscriptions[type]=[];};wamt.events.addEventType("tick");wamt.events.addEventType("draw");wamt.events.processEventType=function(type,holder)
{var subs=wamt.events.subscriptions[type];if(typeof(subs)!="undefined")
{for(var i=0;i<subs.length;i++)
{var sub=subs[i];sub(holder);}}};wamt.events.addEventListener=function(type,bind)
{if(typeof(wamt.events.subscriptions[type])!="undefined"&&typeof(bind)=="function")
wamt.events.subscriptions[type].push(bind);};wamt.events.subscribe=wamt.events.addEventListener;wamt.events.bind=wamt.events.addEventListener;wamt.time=new Date();wamt.delta=0;wamt.fps=0;Math["radians"]=function(degrees)
...
x*=wamt.delta*0.1;this.x+=x;this.updated=true;};wamt.View.prototype.translateY=function(y)
{if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.y+=y;this.updated=true;};wamt.View.prototype.translate=function(x,y)
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.x+=x;this.y+=y;this.updated=true;};wamt.Box=function(style,width,height,x,y,angle)
{this.collideable=true;this.x=typeof(x)=="undefined"?0:x;this.y=typeof(y)=="undefined"?0:y;this.velocity=[0,0];this.screenX=this.x;this.screenY=this.y;this.angle=typeof(angle)=="undefined"?0:angle;this.radians=typeof(angle)=="undefined"?0:Math.radians(angle);this.width=width;this.height=height;this.style=style;this.shadow=[0,0,0,"rgba(0,0,0,0)"];this.hollow=false;this.computeBounds();};wamt.Box.prototype.constructor=wamt.Box;wamt.Box.prototype.computeBounds=function()
...
{this.screenX=-view.x+this.x+(view.canvas.width/2);this.screenY=-view.y+this.y+(view.canvas.height/2);}}};wamt.Box.prototype.render=function(view)
{var radians=this.radians;view.context.strokeStyle=this.style;view.context.fillStyle=this.style;view.context.shadowOffsetX=this.shadow[0];view.context.shadowOffsetY=this.shadow[1];view.context.shadowBlur=this.shadow[2];view.context.shadowColor=this.shadow[3];if(radians==0)
{if(this.hollow)
...
view.context.strokeStyle="";view.context.fillStyle="";view.context.shadowOffsetX="";view.context.shadowOffsetY="";view.context.shadowBlur="";view.context.shadowColor="";};wamt.Box.prototype.setStyle=function(style)
...
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;this.x+=x;this.scene.updated=true;};wamt.Box.prototype.translateY=function(y)
{if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.y+=y;this.scene.updated=true;};wamt.Box.prototype.translate=function(x,y)
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.x+=x;this.y+=y;this.scene.updated=true;};wamt.Box.prototype.setVelocity=function(x,y)
...
{if(wamt.settings.smoothing)
width*=wamt.delta*0.1;this.width+=width;if(this.width<1)
this.width=1;this.computeBounds();this.scene.updated=true;}
wamt.Box.prototype.stretchY=function(height)
{if(wamt.settings.smoothing)
height*=wamt.delta*0.1;this.height+=height;if(this.height<1)
this.height=1;this.computeBounds();this.scene.updated=true;}
wamt.Box.prototype.stretch=function(width,height)
{if(wamt.settings.smoothing)
width*=wamt.delta*0.1;if(wamt.settings.smoothing)
height*=wamt.delta*0.1;this.width+=width;if(this.width<1)
...
{if(wamt.settings.smoothing)
angle*=wamt.delta*0.1;this.angle+=angle;if(this.angle>360)
this.angle=this.angle-360;else if(this.angle<0)
this.angle=360-this.angle;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Circle=function(style,radius,x,y,angle)
...
{this.screenX=-view.x+this.x+(view.canvas.width/2);this.screenY=-view.y+this.y+(view.canvas.height/2);}}};wamt.Circle.prototype.render=function(view)
...
view.context.shadowOffsetX="";view.context.shadowOffsetY="";view.context.shadowBlur="";view.context.shadowColor="";view.context.fillStyle="";view.context.strokeStyle="";};wamt.Circle.prototype.setStyle=function(style)
...
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;this.x+=x;this.scene.updated=true;};wamt.Circle.prototype.translateY=function(y)
{if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.y+=y;this.scene.updated=true;};wamt.Circle.prototype.translate=function(x,y)
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.x+=x;this.y+=y;this.scene.updated=true;};wamt.Circle.prototype.setVelocity=function(x,y)
...
{if(wamt.settings.smoothing)
radius*=wamt.delta*0.1;this.radius+=radius;if(this.radius<1)
...
angle*=wamt.delta*0.1;this.angle+=angle;if(this.angle>360)
this.angle=this.angle-360;else if(this.angle<0)
this.angle=360-this.angle;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.collision={};wamt.collision.screenPointTest=function(target,x,y)
...
{this.collideable=false;this.x=typeof(x)=="undefined"?0:x;this.y=typeof(y)=="undefined"?0:y;this.velocity=[0,0];this.screenX=this.x;this.screenY=this.y;this.intensity=intensity;this.color=color;this.computeBounds();};wamt.Light.prototype.constructor=wamt.Light;wamt.Light.prototype.computeBounds=function()
...
var mult=0.3/this.intensity;var offx=distx*mult*object.bounds[0];var offy=disty*mult*object.bounds[1];object.setShadow(offx,offy,this.intensity*mult,"rgba(0,0,0,0.35)");}}};wamt.Light.prototype.render=function(view)
{var gradient=view.context.createRadialGradient(this.screenX,this.screenY,0,this.screenX,this.screenY,this.intensity);gradient.addColorStop(0,this.color);gradient.addColorStop(1,"rgba(0,0,0,0)");view.context.fillStyle=gradient;view.context.beginPath();view.context.arc(this.screenX,this.screenY,this.intensity,0,Math.PI*2,false);view.context.fill();view.context.fillStyle="";};wamt.Light.prototype.setColor=function(red,green,blue,alpha)
...
{if(wamt.settings.smoothing)
intensity*=wamt.delta*0.1;this.intensity+=intensity;if(this.intensity<1)
...
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;this.x+=x;this.scene.updated=true;};wamt.Light.prototype.translateY=function(y)
{if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.y+=y;this.scene.updated=true;};wamt.Light.prototype.translate=function(x,y)
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.x+=x;this.y+=y;this.scene.updated=true;};wamt.Light.prototype.setVelocity=function(x,y)
{this.velocity=[x,y];this.scene.updated=true;};wamt.Polygon=function(style,vertices,x,y,angle)
...
{this.screenX=-view.x+this.x+(view.canvas.width/2);this.screenY=-view.y+this.y+(view.canvas.height/2);}}};wamt.Polygon.prototype.render=function(view)
{var radians=this.radians;view.context.fillStyle=this.style;view.context.strokeStyle=this.style;view.context.shadowOffsetX=this.shadow[0];view.context.shadowOffsetY=this.shadow[1];view.context.shadowBlur=this.shadow[2];view.context.shadowColor=this.shadow[3];if(radians==0)
...
view.context.stroke();else
view.context.fill();view.context.restore();}
view.context.fillStyle="";view.context.strokeStyle="";view.context.shadowOffsetX="";view.context.shadowOffsetY="";view.context.shadowBlur="";view.context.shadowColor="";};wamt.Polygon.prototype.setStyle=function(style)
...
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;this.x+=x;this.scene.updated=true;};wamt.Polygon.prototype.translateY=function(y)
{if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.y+=y;this.scene.updated=true;};wamt.Polygon.prototype.translate=function(x,y)
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.x+=x;this.y+=y;this.scene.updated=true;};wamt.Polygon.prototype.setVelocity=function(x,y)
...
{this.screenX=-view.x+this.x+(view.canvas.width/2);this.screenY=-view.y+this.y+(view.canvas.height/2);}}};wamt.Sprite.prototype.render=function(view)
{var radians=this.radians;view.context.shadowOffsetX=this.shadow[0];view.context.shadowOffsetY=this.shadow[1];view.context.shadowBlur=this.shadow[2];view.context.shadowColor=this.shadow[3];var animation=this.tileAnimations[this.tileAnimation];if(typeof(animation)=="undefined")
{if(radians==0)
...
{var fa=this.tileAnimationSpeed/wamt.delta;this.tileAnimationFrame+=fa;if(this.tileAnimationFrame>animation[2]*animation[3]+1)
this.tileAnimationFrame=0;var ff=Math.floor(this.tileAnimationFrame);var tilex=Math.floor(ff%animation[2]);var tiley=Math.floor(ff%animation[3]);if(radians==0)
...
view.context.shadowOffsetX="";view.context.shadowOffsetY="";view.context.shadowBlur="";view.context.shadowColor="";};wamt.Sprite.prototype.setShadow=function(offsetx,offsety,blur,color)
...
{this.width=width;this.height=height;this.tileWidth=width;this.tileHeight=height;this.scene.updated=true;};wamt.Sprite.prototype.clearTileAnimations=function()
...
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;this.x+=x;this.scene.updated=true;};wamt.Sprite.prototype.translateY=function(y)
{if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.y+=y;this.scene.updated=true;};wamt.Sprite.prototype.translate=function(x,y)
{if(wamt.settings.smoothing)
x*=wamt.delta*0.1;if(wamt.settings.smoothing)
y*=wamt.delta*0.1;this.x+=x;this.y+=y;this.scene.updated=true;};wamt.Sprite.prototype.setVelocity=function(x,y)
...
angle*=wamt.delta*0.1;this.angle+=angle;if(this.angle>360)
this.angle=this.angle-360;else if(this.angle<0)
this.angle=360-this.angle;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};wamt.Text=function(text,font,style,x,y,angle)
...
{this.screenX=-view.x+this.x+(view.canvas.width/2);this.screenY=-view.y+this.y+(view.canvas.height/2);}}};wamt.Text.prototype.render=function(view)
{var radians=this.radians;view.context.strokeStyle=this.style;view.context.fillStyle=this.style;view.context.font=this.font;view.context.textAlign=this.align;view.context.shadowOffsetX=this.shadow[0];view.context.shadowOffsetY=this.shadow[1];view.context.shadowBlur=this.shadow[2];view.context.shadowColor=this.shadow[3];if(radians==0)
{if(this.hollow)
...
view.context.strokeStyle="";view.context.fillStyle="";view.context.font="";view.context.shadowOffsetX="";view.context.shadowOffsetY="";view.context.shadowBlur="";view.context.shadowColor="";};wamt.Text.prototype.setStyle=function(style)
...
this.angle=this.angle-360;else if(this.angle<0)
this.angle=360-this.angle;this.radians=Math.radians(this.angle);this.computeBounds();this.scene.updated=true;};