...
window.requestAnimationFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}();wamt.play=function(a){a.worker=setTimeout(function(){a.logic()},1E3/60)};wamt.pause=function(a){clearTimeout(a.worker)};
...
wamt.Scene.prototype.getLayer=function(a){for(var b,c=this.layers,d=0;d<c.length;d++){var e=c[d];if(e.index==a){b=e;break}}return b};wamt.Scene.prototype.createLayer=function(a){var a=new wamt.Layer(this,a),b=this.layers;b.push(a);b.sort(function(a,b){if(a.index<b.index)return-1;return a.index>b.index?1:0});return a};wamt.Scene.prototype.addObject=function(a,b){b=typeof b=="number"?b:0;c=this.getLayer(b);if(typeof c=="undefined")var c=this.createLayer(b);c.addObject(a)};
wamt.Scene.prototype.removeObject=function(a){a.layer.removeObject(a)};wamt.Scene.prototype.clear=function(){this.layers=[];this.updated=!0};wamt.Scene.prototype.logic=function(){for(var a=this.layers,b=0;b<a.length;b++)for(var c=a[b].objects,d=0;d<c.length;d++)c[d].logic(this);this.processEvent("logic",{scene:this});var e=this;this.worker=setTimeout(function(){e.logic()},1E3/60)};wamt.Scene.prototype.addEventListener=function(a,b){typeof this.events[a]=="undefined"&&(this.events[a]=[]);this.events[a].push(b)};
wamt.Scene.prototype.processEvent=function(a,b){var c=this.events[a];if(typeof c!="undefined")for(var d=0;d<c.length;d++)c[d](b)};wamt.View=function(a,b,c){this.events=[];this.canvas=a;this.context=a.getContext("2d");this.x=typeof b=="undefined"?a.width/2:b;this.y=typeof c=="undefined"?a.height/2:c;this.zoom=1};wamt.View.prototype.constructor=wamt.View;
...
wamt.Box.prototype.setWidth=function(a){a<1&&(a=1);this.width=a;this.computeBounds();this.update()};wamt.Box.prototype.setHeight=function(a){a<1&&(a=1);this.height=a;this.computeBounds();this.update()};wamt.Box.prototype.setSize=function(a,b){a<1&&(a=1);b<1&&(b=1);this.width=a;this.height=b;this.computeBounds();this.update()};wamt.Box.prototype.stretchX=function(a){this.width+=a;if(this.width<1)this.width=1;this.computeBounds();this.update()};
wamt.Box.prototype.stretchY=function(a){this.height+=a;if(this.height<1)this.height=1;this.computeBounds();this.update()};wamt.Box.prototype.stretch=function(a,b){this.width+=a;if(this.width<1)this.width=1;this.height+=b;if(this.height<1)this.height=1;this.computeBounds();this.update()};wamt.Box.prototype.setStyle=function(a){this.style=a;this.update()};wamt.Box.prototype.setShadow=function(a,b,c,d){this.shadow=[a,b,c,d];this.update()};
wamt.Box.prototype.setShadowCasting=function(a){this.shadowcast=a;this.update()};wamt.Box.prototype.setOpacity=function(a){this.opacity=a;this.update()};wamt.Box.prototype.setX=function(a){this.x=a;this.update()};wamt.Box.prototype.setY=function(a){this.y=a;this.update()};wamt.Box.prototype.setPosition=function(a,b){this.x=a;this.y=b;this.update()};wamt.Box.prototype.snap=function(a,b){this.translate(-(this.x%a),-(this.y%b))};wamt.Box.prototype.translateX=function(a){this.x+=a;this.update()};
wamt.Box.prototype.translateY=function(a){this.y+=a;this.update()};wamt.Box.prototype.translate=function(a,b){this.x+=a;this.y+=b;this.update()};wamt.Box.prototype.setVelocity=function(a,b){this.velocity=[a,b];this.update()};wamt.Box.prototype.stop=function(){this.velocity=[0,0];this.update()};wamt.Box.prototype.setAngle=function(a){this.angle=a%360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};
wamt.Box.prototype.rotate=function(a){this.angle+=a;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};wamt.Box.prototype.setBehaviour=function(a){this.behaviour=a;typeof a!="undefined"&&a.init(this);this.update()};wamt.Box.prototype.addEventListener=function(a,b){typeof this.events[a]=="undefined"&&(this.events[a]=[]);this.events[a].push(b)};wamt.Box.prototype.processEvent=function(a,b){var c=this.events[a];if(typeof c!="undefined")for(var d=0;d<c.length;d++)c[d](b)};
wamt.Box.prototype.destroy=function(){this.scene.removeObject(this)};wamt.Circle=function(a,b,c,d,e){this.events=[];this.collideable=!0;this.x=typeof c=="undefined"?0:c;this.y=typeof d=="undefined"?0:d;this.velocity=[0,0];this.screenX=this.x;this.screenY=this.y;this.angle=typeof e=="undefined"?0:e;this.radians=typeof e=="undefined"?0:Math.radians(e);this.radius=b;this.style=a;this.shadow=[0,0,0,"rgba(0,0,0,0)"];this.hollow=this.shadowcast=!1;this.visible=!0;this.opacity=1;this.computeBounds()};
wamt.Circle.prototype.constructor=wamt.Circle;wamt.Circle.prototype.computeBounds=function(){this.bounds=[this.radius*2,this.radius*2]};wamt.Circle.prototype.update=function(){if(typeof this.scene!="undefined")this.scene.updated=!0};wamt.Circle.prototype.setColliding=function(a){this.collideable=a};wamt.Circle.prototype.setVisible=function(a){this.visible=a;this.update()};wamt.Circle.prototype.setHollow=function(a){this.hollow=a;this.update()};
...
c.translate(-e,-f);c.beginPath();c.arc(this.screenX,this.screenY,this.radius,0,Math.PI*2,!1);this.hollow?c.stroke():c.fill();c.restore()}c.shadowOffsetX="";c.shadowOffsetY="";c.shadowBlur="";c.shadowColor="";c.fillStyle="";c.strokeStyle="";b&&this.behaviour.render(this);this.processEvent("render",{object:this,view:a})};wamt.Circle.prototype.setRadius=function(a){a<1&&(a=1);this.radius=a;this.computeBounds();this.update()};
wamt.Circle.prototype.stretch=function(a){this.radius+=a;if(this.radius<1)this.radius=1;this.computeBounds();this.update()};wamt.Circle.prototype.setStyle=function(a){this.style=a;this.update()};wamt.Circle.prototype.setShadow=function(a,b,c,d){this.shadow=[a,b,c,d];this.update()};wamt.Circle.prototype.setShadowCasting=function(a){this.shadowcast=a;this.update()};wamt.Circle.prototype.setOpacity=function(a){this.opacity=a;this.update()};wamt.Circle.prototype.setX=function(a){this.x=a;this.update()};
wamt.Circle.prototype.setY=function(a){this.y=a;this.update()};wamt.Circle.prototype.setPosition=function(a,b){this.x=a;this.y=b;this.update()};wamt.Circle.prototype.snap=function(a,b){this.translate(-(this.x%a),-(this.y%b))};wamt.Circle.prototype.translateX=function(a){this.x+=a;this.update()};wamt.Circle.prototype.translateY=function(a){this.y+=a;this.update()};wamt.Circle.prototype.translate=function(a,b){this.x+=a;this.y+=b;this.update()};
wamt.Circle.prototype.setVelocity=function(a,b){this.velocity=[a,b];this.update()};wamt.Circle.prototype.stop=function(){this.velocity=[0,0];this.update()};wamt.Circle.prototype.setAngle=function(a){this.angle=a%360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};wamt.Circle.prototype.rotate=function(a){this.angle+=a;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};
wamt.Circle.prototype.setBehaviour=function(a){this.behaviour=a;typeof a!="undefined"&&a.init(this);this.update()};wamt.Circle.prototype.addEventListener=function(a,b){typeof this.events[a]=="undefined"&&(this.events[a]=[]);this.events[a].push(b)};wamt.Circle.prototype.processEvent=function(a,b){var c=this.events[a];if(typeof c!="undefined")for(var d=0;d<c.length;d++)c[d](b)};wamt.Circle.prototype.destroy=function(){this.scene.removeObject(this)};wamt.collision={};
...
wamt.Light.prototype.setColor=function(a,b,c,d){this.color=a instanceof Array?a:[a,b,c,d];this.update()};wamt.Light.prototype.setIntensity=function(a){a<1&&(a=1);this.intensity=a;this.computeBounds();this.update()};wamt.Light.prototype.intensify=function(a){this.intensity+=a;if(this.intensity<1)this.intensity=1;this.computeBounds();this.update()};wamt.Light.prototype.setOpacity=function(a){this.opacity=a;this.update()};wamt.Light.prototype.setX=function(a){this.x=a;this.update()};
wamt.Light.prototype.setY=function(a){this.y=a;this.update()};wamt.Light.prototype.setPosition=function(a,b){this.x=a;this.y=b;this.update()};wamt.Light.prototype.snap=function(a,b){this.translate(-(this.x%a),-(this.y%b))};wamt.Light.prototype.translateX=function(a){this.x+=a;this.update()};wamt.Light.prototype.translateY=function(a){this.y+=a;this.update()};wamt.Light.prototype.translate=function(a,b){this.x+=a;this.y+=b;this.update()};
wamt.Light.prototype.setVelocity=function(a,b){this.velocity=[a,b];this.update()};wamt.Light.prototype.stop=function(){this.velocity=[0,0];this.update()};wamt.Light.prototype.setBehaviour=function(a){this.behaviour=a;typeof a!="undefined"&&a.init(this);this.update()};wamt.Light.prototype.addEventListener=function(a,b){typeof this.events[a]=="undefined"&&(this.events[a]=[]);this.events[a].push(b)};
...
wamt.Polygon.prototype.computeBounds=function(){for(var a=0,b=0,c=0,d=0,e=0;e<this.vertices.length;e++)var f=this.vertices[e],g=Math.min(a,f[0]),i=Math.min(b,f[0]),h=Math.max(c,f[1]),f=Math.max(d,f[1]),a=g<a?g:a,b=i<b?i:b,c=h>c?h:c,d=f>d?f:d;this.bounds=this.angle?[Math.abs(Math.cos(this.angle)*(c-a)),Math.abs(Math.sin(this.angle)*(d-b))]:[c-a,d-b]};wamt.Polygon.prototype.update=function(){if(typeof this.scene!="undefined")this.scene.updated=!0};
wamt.Polygon.prototype.setColliding=function(a){this.collideable=a;this.update()};wamt.Polygon.prototype.setVisible=function(a){this.visible=a;this.update()};wamt.Polygon.prototype.setHollow=function(a){this.hollow=a;this.update()};
wamt.Polygon.prototype.logic=function(a){var b=typeof this.behaviour!="undefined";b&&this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)b?this.behaviour.velocity(this):this.translate(this.velocity[0],this.velocity[1]);b&&this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:a})};
...
g=this.height/2+this.screenY;d.save();d.translate(f,g);d.rotate(c);d.translate(-f,-g);d.beginPath();for(c=0;c<e.length;c++)f=e[c],d.lineTo(this.screenX+f[0],this.screenY+f[1]);this.hollow?d.stroke():d.fill();d.restore()}d.fillStyle="";d.strokeStyle="";d.shadowOffsetX="";d.shadowOffsetY="";d.shadowBlur="";d.shadowColor="";b&&this.behaviour.render(this);this.processEvent("render",{object:this,view:a})};wamt.Polygon.prototype.setVertices=function(a){this.vertices=a;this.computeBounds();this.update()};
wamt.Polygon.prototype.stretchX=function(a){for(var b=this.vertices,c=0;c<b.length;c++)vertice=b[c],vertice[0]+=a;this.computeBounds();this.update()};wamt.Polygon.prototype.stretchY=function(a){for(var b=this.vertices,c=0;c<b.length;c++)vertice=b[c],vertice[1]+=a;this.computeBounds();this.update()};wamt.Polygon.prototype.stretch=function(a,b){for(var c=this.vertices,d=0;d<c.length;d++)vertice=c[d],vertice[0]+=a,vertice[1]+=b;this.computeBounds();this.update()};
wamt.Polygon.prototype.setStyle=function(a){this.style=a;this.update()};wamt.Polygon.prototype.setShadow=function(a,b,c,d){this.shadow=[a,b,c,d];this.update()};wamt.Polygon.prototype.setShadowCasting=function(a){this.shadowcast=a;this.update()};wamt.Polygon.prototype.setOpacity=function(a){this.opacity=a;this.update()};wamt.Polygon.prototype.setX=function(a){this.x=a;this.update()};wamt.Polygon.prototype.setY=function(a){this.y=a;this.update()};
wamt.Polygon.prototype.setPosition=function(a,b){this.x=a;this.y=b;this.update()};wamt.Polygon.prototype.snap=function(a,b){this.translate(-(this.x%a),-(this.y%b))};wamt.Polygon.prototype.translateX=function(a){this.x+=a;this.update()};wamt.Polygon.prototype.translateY=function(a){this.y+=a;this.update()};wamt.Polygon.prototype.translate=function(a,b){this.x+=a;this.y+=b;this.update()};wamt.Polygon.prototype.setVelocity=function(a,b){this.velocity=[a,b];this.update()};
wamt.Polygon.prototype.stop=function(){this.velocity=[0,0];this.update()};wamt.Polygon.prototype.setAngle=function(a){this.angle=a%360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};wamt.Polygon.prototype.rotate=function(a){this.angle+=a;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};wamt.Polygon.prototype.setBehaviour=function(a){this.behaviour=a;typeof a!="undefined"&&a.init(this);this.update()};
wamt.Polygon.prototype.addEventListener=function(a,b){typeof this.events[a]=="undefined"&&(this.events[a]=[]);this.events[a].push(b)};wamt.Polygon.prototype.processEvent=function(a,b){var c=this.events[a];if(typeof c!="undefined")for(var d=0;d<c.length;d++)c[d](b)};wamt.Polygon.prototype.destroy=function(){this.scene.removeObject(this)};
...
wamt.Sprite.prototype.update=function(){if(typeof this.scene!="undefined")this.scene.updated=!0};wamt.Sprite.prototype.setColliding=function(a){this.collideable=a};wamt.Sprite.prototype.setVisible=function(a){this.visible=a;this.update()};
wamt.Sprite.prototype.logic=function(a){var b=typeof this.behaviour!="undefined";b&&this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)b?this.behaviour.velocity(this):this.translate(this.velocity[0],this.velocity[1]);b&&this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:a})};
wamt.Sprite.prototype.tick=function(a,b,c){var d=typeof this.behaviour!="undefined";d&&this.behaviour.pretick(this);if(a.updated)b.locked?(this.screenX=this.x,this.screenY=this.y):(this.screenX=-c.x+this.x+c.canvas.width/2,this.screenY=-c.y+this.y+c.canvas.height/2);if(this.tileAnimation!=""&&this.tileAnimationSpeed>0)a.updated=1;d&&this.behaviour.tick(this);this.processEvent("tick",{object:this,scene:a,layer:b,view:c})};
...
view:a})};wamt.Sprite.prototype.setImage=function(a){a=typeof a.data!="undefined"?a.canvas:a;this.clearTileAnimations();this.image=a;var b=typeof a.videoWidth!="undefined";this.width=b?a.videoWidth:a.width;this.height=b?a.videoHeight:a.height;this.computeBounds();this.update()};wamt.Sprite.prototype.setTiling=function(a,b){this.width=a;this.height=b;this.computeBounds();this.tileWidth=a;this.tileHeight=b;this.update()};
wamt.Sprite.prototype.clearTileAnimations=function(){this.tileAnimation="";this.tileAnimationSpeed=this.tileAnimationFrame=0;this.tileAnimations=[]};wamt.Sprite.prototype.addTileAnimation=function(a,b,c,d,e){this.tileAnimations[a]=[b,c,d,e]};wamt.Sprite.prototype.playTileAnimation=function(a,b){var c=this.tileAnimations[a];if(typeof c!="undefined"){b=typeof b=="number"?b:1;c[2]<=1&&c[3]<=1&&(b=0);if(a!=this.tileAnimation)this.tileAnimationFrame=0;this.tileAnimation=a;this.tileAnimationSpeed=b;this.update()}};
wamt.Sprite.prototype.setTileAnimationSpeed=function(a){animation[0]==animation[2]&&animation[1]==animation[3]&&(a=0);this.tileAnimationSpeed=a;this.update()};wamt.Sprite.prototype.pauseTileAnimation=function(){this.tileAnimationSpeed=0};wamt.Sprite.prototype.setWidth=function(a){a<1&&(a=1);this.width=a;this.computeBounds();this.update()};wamt.Sprite.prototype.setHeight=function(a){a<1&&(a=1);this.height=a;this.computeBounds();this.update()};
wamt.Sprite.prototype.setSize=function(a,b){a<1&&(a=1);b<1&&(b=1);this.width=a;this.height=b;this.computeBounds();this.update()};wamt.Sprite.prototype.stretchX=function(a){this.width+=a;if(this.width<1)this.width=1;this.computeBounds();this.update()};wamt.Sprite.prototype.stretchY=function(a){this.height+=a;if(this.height<1)this.height=1;this.computeBounds();this.update()};
wamt.Sprite.prototype.stretch=function(a,b){this.width+=a;if(this.width<1)this.width=1;this.height+=b;if(this.height<1)this.height=1;this.computeBounds();this.update()};wamt.Sprite.prototype.setShadow=function(a,b,c,d){this.shadow=[a,b,c,d];this.update()};wamt.Sprite.prototype.setShadowCasting=function(a){this.shadowcast=a;this.update()};wamt.Sprite.prototype.setOpacity=function(a){this.opacity=a;this.update()};wamt.Sprite.prototype.setX=function(a){this.x=a;this.update()};
wamt.Sprite.prototype.setY=function(a){this.y=a;this.update()};wamt.Sprite.prototype.setPosition=function(a,b){this.x=a;this.y=b;this.update()};wamt.Sprite.prototype.snap=function(a,b){this.translate(-(this.x%a),-(this.y%b))};wamt.Sprite.prototype.translateX=function(a){this.x+=a;this.update()};wamt.Sprite.prototype.translateY=function(a){this.y+=a;this.update()};wamt.Sprite.prototype.translate=function(a,b){this.x+=a;this.y+=b;this.update()};
wamt.Sprite.prototype.setVelocity=function(a,b){this.velocity=[a,b];this.update()};wamt.Sprite.prototype.stop=function(){this.velocity=[0,0];this.update()};wamt.Sprite.prototype.setAngle=function(a){this.angle=a%360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};wamt.Sprite.prototype.rotate=function(a){this.angle+=a;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};
wamt.Sprite.prototype.setBehaviour=function(a){this.behaviour=a;typeof a!="undefined"&&a.init(this);this.update()};wamt.Sprite.prototype.addEventListener=function(a,b){typeof this.events[a]=="undefined"&&(this.events[a]=[]);this.events[a].push(b)};wamt.Sprite.prototype.processEvent=function(a,b){var c=this.events[a];if(typeof c!="undefined")for(var d=0;d<c.length;d++)c[d](b)};wamt.Sprite.prototype.destroy=function(){this.scene.removeObject(this)};
...
wamt.Text.prototype.constructor=wamt.Text;wamt.Text.prototype.computeBounds=function(){this.bounds=this.angle==0||this.angle==180?[this.width,this.height]:this.angle==90||this.angle==270?[this.height,this.width]:[Math.abs(Math.cos(this.angle)*this.width),Math.abs(Math.sin(this.angle)*this.height)]};wamt.Text.prototype.update=function(){if(typeof this.scene!="undefined")this.scene.updated=!0};wamt.Text.prototype.setColliding=function(a){this.collideable=a};
wamt.Text.prototype.setVisible=function(a){this.visible=a;this.update()};wamt.Text.prototype.setHollow=function(a){this.hollow=a;this.update()};wamt.Text.prototype.logic=function(a){var b=typeof this.behaviour!="undefined";b&&this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)b?this.behaviour.velocity(this):this.translate(this.velocity[0],this.velocity[1]);b&&this.behaviour.logic(this);this.processEvent("logic",{object:this,scene:a})};
...
d.shadowOffsetX="";d.shadowOffsetY="";d.shadowBlur="";d.shadowColor="";b&&this.behaviour.render(this);this.processEvent("render",{object:this,view:a})};wamt.Text.prototype.setStyle=function(a){this.style=a;this.updated=!0;this.update()};wamt.Text.prototype.setFont=function(a){this.font=a;this.updated=!0;this.update()};wamt.Text.prototype.setText=function(a){this.text=String(a).split("\n");this.updated=!0;this.update()};wamt.Text.prototype.setTextAlign=function(a){this.align=a;this.update()};
wamt.Text.prototype.setShadow=function(a,b,c,d){this.shadow=[a,b,c,d];this.update()};wamt.Text.prototype.setShadowCasting=function(a){this.shadowcast=a;this.update()};wamt.Text.prototype.setOpacity=function(a){this.opacity=a;this.update()};wamt.Text.prototype.setX=function(a){this.x=a;this.update()};wamt.Text.prototype.setY=function(a){this.y=a;this.update()};wamt.Text.prototype.setPosition=function(a,b){this.x=a;this.y=b;this.update()};
wamt.Text.prototype.snap=function(a,b){this.translate(-(this.x%a),-(this.y%b))};wamt.Text.prototype.translateX=function(a){this.x+=a;this.update()};wamt.Text.prototype.translateY=function(a){this.y+=a;this.update()};wamt.Text.prototype.translate=function(a,b){this.x+=a;this.y+=b;this.update()};wamt.Text.prototype.setVelocity=function(a,b){this.velocity=[a,b];this.update()};wamt.Text.prototype.stop=function(){this.velocity=[0,0];this.update()};
wamt.Text.prototype.setAngle=function(a){this.angle=a%360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};wamt.Text.prototype.rotate=function(a){this.angle+=a;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};wamt.Text.prototype.setBehaviour=function(a){this.behaviour=a;typeof a!="undefined"&&a.init(this);this.update()};wamt.Text.prototype.addEventListener=function(a,b){typeof this.events[a]=="undefined"&&(this.events[a]=[]);this.events[a].push(b)};
wamt.Text.prototype.processEvent=function(a,b){var c=this.events[a];if(typeof c!="undefined")for(var d=0;d<c.length;d++)c[d](b)};wamt.Text.prototype.destroy=function(){this.scene.removeObject(this)};
