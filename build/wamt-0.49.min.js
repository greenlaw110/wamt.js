...
wamt.Sprite.prototype.playTileAnimation=function(a,b){var c=this.tileAnimations[a];if(typeof c!="undefined"){b=typeof b=="number"?b:1;c[0]==c[2]&&c[1]==c[3]&&(b=0);if(a!=this.tileAnimation)this.tileAnimationFrame=0;this.tileAnimation=a;this.tileAnimationSpeed=b;this.update()}};wamt.Sprite.prototype.setTileAnimationSpeed=function(a){animation[0]==animation[2]&&animation[1]==animation[3]&&(a=0);this.tileAnimationSpeed=a;this.update()};
wamt.Sprite.prototype.pauseTileAnimation=function(){this.tileAnimationSpeed=0};wamt.Sprite.prototype.setWidth=function(a){a<1&&(a=1);this.width=a;this.computeBounds();this.update()};wamt.Sprite.prototype.setHeight=function(a){a<1&&(a=1);this.height=a;this.computeBounds();this.update()};wamt.Sprite.prototype.setSize=function(a,b){a<1&&(a=1);b<1&&(b=1);this.width=a;this.height=b;this.computeBounds();this.update()};
wamt.Sprite.prototype.stretchX=function(a){this.width+=a;if(this.width<1)this.width=1;this.computeBounds();this.update()};wamt.Sprite.prototype.stretchY=function(a){this.height+=a;if(this.height<1)this.height=1;this.computeBounds();this.update()};wamt.Sprite.prototype.stretch=function(a,b){this.width+=a;if(this.width<1)this.width=1;this.height+=b;if(this.height<1)this.height=1;this.computeBounds();this.update()};wamt.Sprite.prototype.setShadow=function(a,b,c,d){this.shadow=[a,b,c,d];this.update()};
wamt.Sprite.prototype.setShadowCasting=function(a){this.shadowcast=a;this.update()};wamt.Sprite.prototype.setOpacity=function(a){this.opacity=a;this.update()};wamt.Sprite.prototype.setX=function(a){this.x=a;this.update()};wamt.Sprite.prototype.setY=function(a){this.y=a;this.update()};wamt.Sprite.prototype.setPosition=function(a,b){this.x=a;this.y=b;this.update()};wamt.Sprite.prototype.snap=function(a,b){this.translate(-(this.x%a),-(this.y%b))};
wamt.Sprite.prototype.translateX=function(a){this.x+=a;this.update()};wamt.Sprite.prototype.translateY=function(a){this.y+=a;this.update()};wamt.Sprite.prototype.translate=function(a,b){this.x+=a;this.y+=b;this.update()};wamt.Sprite.prototype.setVelocity=function(a,b){this.velocity=[a,b];this.update()};wamt.Sprite.prototype.stop=function(){this.velocity=[0,0];this.update()};wamt.Sprite.prototype.setAngle=function(a){this.angle=a%360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};
wamt.Sprite.prototype.rotate=function(a){this.angle+=a;this.angle%=360;this.radians=Math.radians(this.angle);this.computeBounds();this.update()};wamt.Sprite.prototype.setBehaviour=function(a){this.behaviour=a;typeof a!="undefined"&&a.init(this);this.update()};wamt.Sprite.prototype.addEventListener=function(a,b){typeof this.events[a]=="undefined"&&(this.events[a]=[]);this.events[a].push(b)};
wamt.Sprite.prototype.processEvent=function(a,b){var c=this.events[a];if(typeof c!="undefined")for(var d=0;d<c.length;d++)c[d](b)};wamt.Sprite.prototype.destroy=function(){this.scene.removeObject(this)};
