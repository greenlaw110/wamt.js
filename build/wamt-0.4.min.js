...
{this.scene.removeObject(this);};wamt.collision={};wamt.collision.screenPointTest=function(target,x,y)
...
{this.bounds=[this.intensity*2,this.intensity*2];};wamt.Light.prototype.logic=function(scene,layer,view)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.velocity(this);else
...
{this.scene.removeObject(this);};self.setInterval("postMessage();",16.6666667);wamt.Polygon=function(style,vertices,x,y,angle)
...
{this.collideable=colliding;};wamt.Sprite.prototype.logic=function(scene)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.prelogic(this);if(this.velocity[0]!=0||this.velocity[1]!=0)
{if(typeof(this.behaviour)!="undefined")
this.behaviour.velocity(this);else
