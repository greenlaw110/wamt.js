...
{event.view=this;event.context=this.view;bind(event);});break;}};wamt.View.prototype.processEvent=function(type,holder)
{var e=this.events[type];if(typeof(e)!="undefined")
{for(var i=0;i<e.length;i++)
...
continue;if((x>b.screenX&&x<b.screenX+(b.bounds[0]))&&(y>b.screenY-(b.bounds[1])&&y<b.screenY))
collisions.push(b);}}
else
...
continue;if((x>=b.screenX&&x<=b.screenX+(b.bounds[0]))&&(y>=b.screenY&&y<=b.screenY+(b.bounds[1])))
collisions.push(b);}}}
...
{for(var i=0;i<target.objects.length;i++)
{var b=target.objects[i];if(!b.collideable||b==n)
continue;if((x>b.x&&x<b.x+(b.bounds[0]))&&(y>b.y-(b.bounds[1])&&y<b.y))
collisions.push(b);}}
else
{for(var l=0;l<target.layers.length;l++)
{var layer=target.layers[l];for(var i=0;i<layer.objects.length;i++)
